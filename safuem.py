...
def xx(call):
    ...
    """)
        ...
        blist = [
            ...
            {"action": "Devices", "subaction": "SetPushUId",
             "pushuid": "*epGgiFFeSg2sxg2uzlqiMd:APA91bFNWtNdleljmYAf9sJPfE-EOWSuAnacf8OoUDgTGcBh9bu90JcVtVpjQyuD3ZVcFBmu3qw6LvaN2yqYpwnX_arO074j-TncaYSj1CFTMd_AQLfpp9OVzO1fI-BPBsh2Psey59WY",
             "id": "2078941368"},
                ...
                for _ in range(11):
                    ...
                    if "billingData" in json.loads(gzip.decompress(response)):
                        ...
                        if str(number[:6]) in numbers:
                            bot.reply_to(call.message, f"تم فحص حساب {user}\n {number}")
                            return 0
